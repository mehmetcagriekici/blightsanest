...
func PrintSearchHelp() {
	...
	fmt.Println("")
	fmt.Println("To use the Semantic Search on existing database index: * search semantic <asset> <query>")
	fmt.Println(" - Example: search semantic crypto find the tokens with 100 dollars current price.")
